...
<body style=" width: 100%">
  ...
  <div class="row">
    <nav class="navbar navbar-expand-md fixed-top" style="background: #03263A;">
  ...
  <div class="row" style="margin-top:100px;">
    <div class="container" style="width: 50%">
      ...
      <img src="KTMWEB.jpg" class="mx-auto d-block" style="width:100%; padding-top: 8px"> 
  ...
  <div class = "row" style="background: #03263A; padding: 20px; margin-top: 65px; color: #F9F4F5">
    <div class="container">
